...
import com.formance.ledgerclient.api.AccountsApi;
...
> ListAccountsResponse listAccounts(ledger, after, address, metadata, balance, balanceOperator, paginationToken)
...
public class Example {
    public static void main(String[] args) {
        ...
        try {
            ListAccountsResponse result = apiInstance.listAccounts(ledger, after, address, metadata, balance, balanceOperator, paginationToken);
            System.out.println(result);
        } catch (ApiException e) {
