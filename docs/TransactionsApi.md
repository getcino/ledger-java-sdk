...
import com.formance.ledgerclient.api.TransactionsApi;
...
public class Example {
    public static void main(String[] args) {
        ...
        String account = "users:001"; // String | Filter transactions with postings involving given account, either as source or destination.
        String source = "users:001"; // String | Filter transactions with postings involving given account at source.
        String destination = "users:001"; // String | Filter transactions with postings involving given account at destination.
        try {
...
> ListTransactionsResponse listTransactions(ledger, after, reference, account, source, destination, startTime, endTime, paginationToken)
...
public class Example {
    public static void main(String[] args) {
        ...
        try {
            ListTransactionsResponse result = apiInstance.listTransactions(ledger, after, reference, account, source, destination, startTime, endTime, paginationToken);
            System.out.println(result);
        } catch (ApiException e) {
